...
class AIBot:
    ...
    def invoke(self, history_messages, question):
        ...
        Você é um assistente especializado em tirar dúvidas sobre o livro 10X - A regra que faz diferença 
        entre o sucesso e o fracasso.
        Tire dúvidas das pessoas que entrarem em contato.
        ...
        Responda sempre em no máximo 500 caracteres. 
        <context>
        {context}
        </context>
        '''
